...
export default function Footer() {
  return (
    <>
      {/* Копирайт и юридические ссылки — на обычном фоне страницы, не на чёрной плашке */}
      <div className="footer-legal">
        <p className="footer-legal__copy">© {new Date().getFullYear()} «LOBOTOMY»</p>
      ...
      {/* Сама чёрная плашка — как было изначально, только соцсети */}
